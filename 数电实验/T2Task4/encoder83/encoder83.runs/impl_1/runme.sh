...
HD_PWD='C:/Users/lenovo/Desktop/T2Task4/encoder83/encoder83.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log encoder83.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source encoder83.tcl -notrace
